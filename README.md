...
Second, [The Tech Interview Handbook](https://github.com/yangshun/tech-interview-handbook) does a great job explaining the logistics from start to end of the actual interview (along with providing helpful resources on algorithms, etc.) **I'm not going to explain the actual interview process, and this link does it much better than I could ever. Please refer to as necessary.**
